...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User tester = userLoggedInService.getLoggedInUser(); // fetching current logged in user i.e. current tester who has logged in.
        return testRequestQueryService.findByTester(tester); // returning the list of test requests assigned to current logged in tester.
