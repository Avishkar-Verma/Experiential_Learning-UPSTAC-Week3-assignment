...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        return testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED); // fetching list of test requests whose Lab_test_completed
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        User doctor = userLoggedInService.getLoggedInUser(); // fetching current logged in user i.e. current doctor who has logged in.
        return testRequestQueryService.findByDoctor(doctor); // returning the list of test requests assigned to current logged in doctor.
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            User doctor = userLoggedInService.getLoggedInUser(); // fetching current logged in user i.e. current doctor who has logged in.
            return testRequestUpdateService.assignForConsultation(id,doctor); // assigning the particular id to the current logged in doctor for consultation and returning the same TestRequest object returned by the assignForConsultation() method.
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            User doctor = userLoggedInService.getLoggedInUser(); // fetching current logged in user i.e. current doctor who has logged in.
            return testRequestUpdateService.updateConsultation(id,testResult,doctor); // updating the result of current test request id with test doctor comments and suggestions.
